...
document.getElementById("sketch_instructor").innerHTML = "Sketch To Be Drawn: "+Element_of_array;
...
function check_sketch(){
    timer_counter++;
    document.getElementById("timershower").innerHTML = "Timer"+timer_counter;
...
function updateCanvas(){
    background("white");
    sketch = Element_of_array;
    document.getElementById("sketch_instructor").innerHTML = "Sketch to be Drawn"+sketch;
}
function setup(){
...
function gotResult(error, results){
 if (error){
    console.error(error);
     ...
     document.getElementById('yoursketch')
 }
}
